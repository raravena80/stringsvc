GOPKG_BASE := github.com/raravena80/stringsvc
...
build: workdir/stringsvc

build-native: $(GOFILES)
	go build $(GO_LDFLAGS) -o workdir/stringsvc .

workdir/stringsvc: $(GOFILES)
	GOOS=linux GOARCH=amd64 CGO_ENABLED=0 go build $(GO_LDFLAGS) -o workdir/stringsvc.linux.amd64 .
